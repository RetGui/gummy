...
use crate::{
    prelude::{FromLength, GummyMaxContent, GummyMinContent, GummyZero},
    sys::abs,
    Size,
};
...
impl GummyZero for AvailableSpace {
    const ZERO: Self = Self::Definite(0.0);
}
impl GummyMaxContent for AvailableSpace {
    const MAX_CONTENT: Self = Self::MaxContent;
}
impl GummyMinContent for AvailableSpace {
